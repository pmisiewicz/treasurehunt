...
void main() {
	...
	`}function rx(s){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===Fc||c===Oc,h=c===Ks||c===$s;if(l||h){let u=e.get(a);const d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new _h(s)),u=l?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{const f=a.image;return l&&f&&f.height>0||h&&f&&i(f)?(t===null&&(t=new _h(s)),u=l?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function i(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function ox(s){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&Gr("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function ax(s,e,t,n){const i={},r=new WeakMap;function o(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);d.removeEventListener("dispose",o),delete i[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(u,d){return i[d.id]===!0||(d.addEventListener("dispose",o),i[d.id]=!0,t.memory.geometries++),d}function c(u){const d=u.attributes;for(const f in d)e.update(d[f],s.ARRAY_BUFFER)}function l(u){const d=[],f=u.index,g=u.attributes.position;let x=0;if(f!==null){const T=f.array;x=f.version;for(let v=0,_=T.length;v<_;v+=3){const y=T[v+0],E=T[v+1],w=T[v+2];d.push(y,E,E,w,w,y)}}else if(g!==void 0){const T=g.array;x=g.version;for(let v=0,_=T.length/3-1;v<_;v+=3){const y=v+0,E=v+1,w=v+2;d.push(y,E,E,w,w,y)}}else return;const m=new(Dd(d)?Od:Fd)(d,1);m.version=x;const p=r.get(u);p&&e.remove(p),r.set(u,m)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function cx(s,e,t){let n;function i(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function c(d,f){s.drawElements(n,f,r,d*o),t.update(f,n,1)}function l(d,f,g){g!==0&&(s.drawElementsInstanced(n,f,r,d*o,g),t.update(f,n,g))}function h(d,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function u(d,f,g,x){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)l(d[p]/o,f[p],x[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,x,0,g);let p=0;for(let T=0;T<g;T++)p+=f[T]*x[T];t.update(p,n,1)}}this.setMode=i,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function lx(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case s.TRIANGLES:t.triangles+=a*(r/3);break;case s.LINES:t.lines+=a*(r/2);break;case s.LINE_STRIP:t.lines+=a*(r-1);break;case s.LINE_LOOP:t.lines+=a*r;break;case s.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function ux(s,e,t){const n=new WeakMap,i=new Ze;function r(o,a,c){const l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(a);if(d===void 0||d.count!==u){let M=function(){w.dispose(),n.delete(a),a.removeEventListener("dispose",M)};d!==void 0&&d.texture.dispose();const f=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,x=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],T=a.morphAttributes.color||[];let v=0;f===!0&&(v=1),g===!0&&(v=2),x===!0&&(v=3);let _=a.attributes.position.count*v,y=1;_>e.maxTextureSize&&(y=Math.ceil(_/e.maxTextureSize),_=e.maxTextureSize);const E=new Float32Array(_*y*4*u),w=new Ud(E,_,y,u);w.type=Rn,w.needsUpdate=!0;const R=v*4;for(let S=0;S<u;S++){const P=m[S],C=p[S],D=T[S],N=_*y*4*S;for(let O=0;O<P.count;O++){const F=O*R;f===!0&&(i.fromBufferAttribute(P,O),E[N+F+0]=i.x,E[N+F+1]=i.y,E[N+F+2]=i.z,E[N+F+3]=0),g===!0&&(i.fromBufferAttribute(C,O),E[N+F+4]=i.x,E[N+F+5]=i.y,E[N+F+6]=i.z,E[N+F+7]=0),x===!0&&(i.fromBufferAttribute(D,O),E[N+F+8]=i.x,E[N+F+9]=i.y,E[N+F+10]=i.z,E[N+F+11]=D.itemSize===4?i.w:1)}}d={count:u,texture:w,size:new Fe(_,y)},n.set(a,d),a.addEventListener("dispose",M)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(s,"morphTexture",o.morphTexture,t);else{let f=0;for(let x=0;x<l.length;x++)f+=l[x];const g=a.morphTargetsRelative?1:1-f;c.getUniforms().setValue(s,"morphTargetBaseInfluence",g),c.getUniforms().setValue(s,"morphTargetInfluences",l)}c.getUniforms().setValue(s,"morphTargetsTexture",d.texture,t),c.getUniforms().setValue(s,"morphTargetsTextureSize",d.size)}return{update:r}}function hx(s,e,t,n){let i=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=e.get(c,h);if(i.get(u)!==l&&(e.update(u),i.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),i.get(c)!==l&&(t.update(c.instanceMatrix,s.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,s.ARRAY_BUFFER),i.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;i.get(d)!==l&&(d.update(),i.set(d,l))}return u}function o(){i=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:o}}const sf=new Et,Mh=new qd(1,1),rf=new Ud,of=new nm,af=new zd,Sh=[],Th=[],Eh=new Float32Array(16),wh=new Float32Array(9),Ah=new Float32Array(4);function rr(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=Sh[i];if(r===void 0&&(r=new Float32Array(i),Sh[i]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,s[o].toArray(r,a)}return r}function Pt(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function Lt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function Sa(s,e){let t=Th[e];t===void 0&&(t=new Int32Array(e),Th[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function dx(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function fx(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Pt(t,e))return;s.uniform2fv(this.addr,e),Lt(t,e)}}function px(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Pt(t,e))return;s.uniform3fv(this.addr,e),Lt(t,e)}}function mx(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Pt(t,e))return;s.uniform4fv(this.addr,e),Lt(t,e)}}function gx(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(Pt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),Lt(t,e)}else{if(Pt(t,n))return;Ah.set(n),s.uniformMatrix2fv(this.addr,!1,Ah),Lt(t,n)}}function _x(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(Pt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),Lt(t,e)}else{if(Pt(t,n))return;wh.set(n),s.uniformMatrix3fv(this.addr,!1,wh),Lt(t,n)}}function xx(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(Pt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),Lt(t,e)}else{if(Pt(t,n))return;Eh.set(n),s.uniformMatrix4fv(this.addr,!1,Eh),Lt(t,n)}}function vx(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function yx(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Pt(t,e))return;s.uniform2iv(this.addr,e),Lt(t,e)}}function Mx(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Pt(t,e))return;s.uniform3iv(this.addr,e),Lt(t,e)}}function Sx(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Pt(t,e))return;s.uniform4iv(this.addr,e),Lt(t,e)}}function Tx(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function Ex(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Pt(t,e))return;s.uniform2uiv(this.addr,e),Lt(t,e)}}function wx(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Pt(t,e))return;s.uniform3uiv(this.addr,e),Lt(t,e)}}function Ax(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Pt(t,e))return;s.uniform4uiv(this.addr,e),Lt(t,e)}}function bx(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(Mh.compareFunction=Id,r=Mh):r=sf,t.setTexture2D(e||r,i)}function Rx(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||of,i)}function Cx(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||af,i)}function Px(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||rf,i)}function Lx(s){switch(s){case 5126:return dx;case 35664:return fx;case 35665:return px;case 35666:return mx;case 35674:return gx;case 35675:return _x;case 35676:return xx;case 5124:case 35670:return vx;case 35667:case 35671:return yx;case 35668:case 35672:return Mx;case 35669:case 35673:return Sx;case 5125:return Tx;case 36294:return Ex;case 36295:return wx;case 36296:return Ax;case 35678:case 36198:case 36298:case 36306:case 35682:return bx;case 35679:case 36299:case 36307:return Rx;case 35680:case 36300:case 36308:case 36293:return Cx;case 36289:case 36303:case 36311:case 36292:return Px}}function Ix(s,e){s.uniform1fv(this.addr,e)}function Dx(s,e){const t=rr(e,this.size,2);s.uniform2fv(this.addr,t)}function Ux(s,e){const t=rr(e,this.size,3);s.uniform3fv(this.addr,t)}function Nx(s,e){const t=rr(e,this.size,4);s.uniform4fv(this.addr,t)}function Fx(s,e){const t=rr(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function Ox(s,e){const t=rr(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function Bx(s,e){const t=rr(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function kx(s,e){s.uniform1iv(this.addr,e)}function zx(s,e){s.uniform2iv(this.addr,e)}function Vx(s,e){s.uniform3iv(this.addr,e)}function Hx(s,e){s.uniform4iv(this.addr,e)}function Gx(s,e){s.uniform1uiv(this.addr,e)}function Wx(s,e){s.uniform2uiv(this.addr,e)}function Xx(s,e){s.uniform3uiv(this.addr,e)}function qx(s,e){s.uniform4uiv(this.addr,e)}function Yx(s,e,t){const n=this.cache,i=e.length,r=Sa(t,i);Pt(n,r)||(s.uniform1iv(this.addr,r),Lt(n,r));for(let o=0;o!==i;++o)t.setTexture2D(e[o]||sf,r[o])}function jx(s,e,t){const n=this.cache,i=e.length,r=Sa(t,i);Pt(n,r)||(s.uniform1iv(this.addr,r),Lt(n,r));for(let o=0;o!==i;++o)t.setTexture3D(e[o]||of,r[o])}function Kx(s,e,t){const n=this.cache,i=e.length,r=Sa(t,i);Pt(n,r)||(s.uniform1iv(this.addr,r),Lt(n,r));for(let o=0;o!==i;++o)t.setTextureCube(e[o]||af,r[o])}function $x(s,e,t){const n=this.cache,i=e.length,r=Sa(t,i);Pt(n,r)||(s.uniform1iv(this.addr,r),Lt(n,r));for(let o=0;o!==i;++o)t.setTexture2DArray(e[o]||rf,r[o])}function Zx(s){switch(s){case 5126:return Ix;case 35664:return Dx;case 35665:return Ux;case 35666:return Nx;case 35674:return Fx;case 35675:return Ox;case 35676:return Bx;case 5124:case 35670:return kx;case 35667:case 35671:return zx;case 35668:case 35672:return Vx;case 35669:case 35673:return Hx;case 5125:return Gx;case 36294:return Wx;case 36295:return Xx;case 36296:return qx;case 35678:case 36198:case 36298:case 36306:case 35682:return Yx;case 35679:case 36299:case 36307:return jx;case 35680:case 36300:case 36308:case 36293:return Kx;case 36289:case 36303:case 36311:case 36292:return $x}}class Jx{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Lx(t.type)}}class Qx{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Zx(t.type)}}class ev{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,o=i.length;r!==o;++r){const a=i[r];a.setValue(e,t[a.id],n)}}}const lc=/(\w+)(\])?(\[|\.)?/g;function bh(s,e){s.seq.push(e),s.map[e.id]=e}function tv(s,e,t){const n=s.name,i=n.length;for(lc.lastIndex=0;;){const r=lc.exec(n),o=lc.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===i){bh(t,l===void 0?new Jx(a,s,e):new Qx(a,s,e));break}else{let u=t.map[a];u===void 0&&(u=new ev(a),bh(t,u)),t=u}}}class ea{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),o=e.getUniformLocation(t,r.name);tv(r,o,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,o=t.length;r!==o;++r){const a=t[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const o=e[i];o.id in t&&n.push(o)}return n}}function Rh(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const nv=37297;let iv=0;function sv(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=i;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const Ch=new Ve;function rv(s){$e._getMatrix(Ch,$e.workingColorSpace,s);const e=`mat3( ${Ch.elements.map(t=>t.toFixed(4))} )`;switch($e.getTransfer(s)){case ca:return[e,"LinearTransferOETF"];case rt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function Ph(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),r=(s.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const o=/ERROR: 0:(\d+)/.exec(r);if(o){const a=parseInt(o[1]);return t.toUpperCase()+`
...
`)}function av(s,e){let t;switch(e){case pp:t="Linear";break;case mp:t="Reinhard";break;case gp:t="Cineon";break;case yd:t="ACESFilmic";break;case xp:t="AgX";break;case vp:t="Neutral";break;case _p:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Po=new L;function cv(){$e.getLuminanceCoefficients(Po);const s=Po.x.toFixed(4),e=Po.y.toFixed(4),t=Po.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function lv(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ar).join(`
`)}function uv(s){const e=[];for(const t in s){const n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function hv(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),o=r.name;let a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:s.getAttribLocation(e,o),locationSize:a}}return t}function Ar(s){return s!==""}function Lh(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ih(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const dv=/^[ \t]*#include +<([\w\d./]+)>/gm;function _l(s){return s.replace(dv,pv)}const fv=new Map;function pv(s,e){let t=Ye[e];if(t===void 0){const n=fv.get(e);if(n!==void 0)t=Ye[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return _l(t)}const mv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Dh(s){return s.replace(mv,gv)}function gv(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function Uh(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function _v(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===_d?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===xd?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ei&&(e="SHADOWMAP_TYPE_VSM"),e}function xv(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ks:case $s:e="ENVMAP_TYPE_CUBE";break;case ga:e="ENVMAP_TYPE_CUBE_UV";break}return e}function vv(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case $s:e="ENVMAP_MODE_REFRACTION";break}return e}function yv(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case vd:e="ENVMAP_BLENDING_MULTIPLY";break;case dp:e="ENVMAP_BLENDING_MIX";break;case fp:e="ENVMAP_BLENDING_ADD";break}return e}function Mv(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Sv(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=_v(t),l=xv(t),h=vv(t),u=yv(t),d=Mv(t),f=lv(t),g=uv(r),x=i.createProgram();let m,p,T=t.glslVersion?"#version "+t.glslVersion+`
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
				...
				void main() {
					...
					#include <colorspace_fragment>
					#include <fog_fragment>	
				}`},O=new Gn({name:N.name,uniforms:pl.clone(N.uniforms),vertexShader:N.vertexShader,fragmentShader:N.fragmentShader,lights:!0,side:x,fog:m});O.uniforms.mirrorSampler.value=D.texture,O.uniforms.textureMatrix.value=P,O.uniforms.alpha.value=a,O.uniforms.time.value=c,O.uniforms.normalSampler.value=l,O.uniforms.sunColor.value=u,O.uniforms.waterColor.value=d,O.uniforms.sunDirection.value=h,O.uniforms.distortionScale.value=g,O.uniforms.eye.value=f,n.material=O,n.onBeforeRender=function(F,q,V){if(v.setFromMatrixPosition(n.matrixWorld),_.setFromMatrixPosition(V.matrixWorld),y.extractRotation(n.matrixWorld),T.set(0,0,1),T.applyMatrix4(y),R.subVectors(v,_),R.dot(T)>0)return;R.reflect(T).negate(),R.add(v),y.extractRotation(V.matrixWorld),E.set(0,0,-1),E.applyMatrix4(y),E.add(_),M.subVectors(v,E),M.reflect(T).negate(),M.add(v),C.position.copy(R),C.up.set(0,1,0),C.up.applyMatrix4(y),C.up.reflect(T),C.lookAt(M),C.far=V.far,C.updateMatrixWorld(),C.projectionMatrix.copy(V.projectionMatrix),P.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),P.multiply(C.projectionMatrix),P.multiply(C.matrixWorldInverse),p.setFromNormalAndCoplanarPoint(T,v),p.applyMatrix4(C.matrixWorldInverse),w.set(p.normal.x,p.normal.y,p.normal.z,p.constant);const K=C.projectionMatrix;S.x=(Math.sign(w.x)+K.elements[8])/K.elements[0],S.y=(Math.sign(w.y)+K.elements[9])/K.elements[5],S.z=-1,S.w=(1+K.elements[10])/K.elements[14],w.multiplyScalar(2/w.dot(S)),K.elements[2]=w.x,K.elements[6]=w.y,K.elements[10]=w.z+1-o,K.elements[14]=w.w,f.setFromMatrixPosition(V.matrixWorld);const ee=F.getRenderTarget(),fe=F.xr.enabled,Ce=F.shadowMap.autoUpdate;n.visible=!1,F.xr.enabled=!1,F.shadowMap.autoUpdate=!1,F.setRenderTarget(D),F.state.buffers.depth.setMask(!0),F.autoClear===!1&&F.clear(),F.render(q,C),n.visible=!0,F.xr.enabled=fe,F.shadowMap.autoUpdate=Ce,F.setRenderTarget(ee);const Pe=V.viewport;Pe!==void 0&&F.state.viewport(Pe)}}}const eM={lowFreq:{phaseX:Yn()*Math.PI*2,phaseZ:Yn()*Math.PI*2,freq:.4+Yn()*.4},midFreq:{phaseX:Yn()*Math.PI*2,phaseZ:Yn()*Math.PI*2,freq:1.2+Yn()*.8},highFreq:{phaseX:Yn()*Math.PI*2,phaseZ:Yn()*Math.PI*2,freq:4+Yn()*2}};function tM(s,e,t,n){const i=eM;let r=0;const o=Math.sqrt(s*s+e*e),a=xt*.4,c=xt*.15;let l=1;if(o>a){const g=o-a,x=Math.min(g/c,1);l=1-x*x*(3-2*x)}r+=Math.sin(s*t*i.lowFreq.freq+i.lowFreq.phaseX)*Math.cos(e*t*i.lowFreq.freq+i.lowFreq.phaseZ)*n*.5,r+=Math.sin(s*t*i.midFreq.freq+i.midFreq.phaseX)*Math.cos(e*t*i.midFreq.freq+i.midFreq.phaseZ)*n*.3,r+=Math.sin(s*t*i.highFreq.freq+i.highFreq.phaseX)*Math.cos(e*t*i.highFreq.freq+i.highFreq.phaseZ)*n*.05,r*=l,r-=(1-l)*(n*1.5),r=pn.clamp(r,-n*1.5,n);const h=G()*.2+.05,u=sa(s*h,e*h),d=Math.max(0,r/n),f=d*d*n*.15;if(r+=u*f,r>n*.3){const g=sa(s*.3,e*.3);r+=g*n*.1}return o>a+c*.5&&(r=Math.min(r,Tt-2)),r}function nM(s,e){const t=new Li(xt*10,xt*10),n=new ya().load("textures/waternormals.jpg",r=>{r.wrapS=r.wrapT=Bn},void 0,r=>{console.warn("Failed to load water normals texture:",r)}),i=new Qy(t,{waterColor:Rl,textureWidth:1024,textureHeight:1024,distortionScale:.2,alpha:1,waterNormals:n,fog:!0});return i.rotation.x=-Math.PI/2,i.position.y=Tt,i.receiveShadow=!0,i.userData.isWater=!0,s.add(i),e.push(i),i}let Os=[];async function iM(){if(Os.length>0)return Os;try{const s=await fetch("/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/data/biomes.json");if(!s.ok)throw new Error(`Failed to load biomes: ${s.statusText}`);return Os=(await s.json()).map(t=>({...t,colors:{submerged:typeof t.colors.submerged=="string"?parseInt(t.colors.submerged,16):t.colors.submerged,low:typeof t.colors.low=="string"?parseInt(t.colors.low,16):t.colors.low,mid:typeof t.colors.mid=="string"?parseInt(t.colors.mid,16):t.colors.mid,high:typeof t.colors.high=="string"?parseInt(t.colors.high,16):t.colors.high,rock:typeof t.colors.rock=="string"?parseInt(t.colors.rock,16):t.colors.rock,peak:typeof t.colors.peak=="string"?parseInt(t.colors.peak,16):t.colors.peak}})),Os}catch(s){return console.error("Failed to load biomes from JSON, using fallback biome:",s),Os=[{name:"Default Forest",colors:{submerged:737335,low:2122554,mid:5869891,high:9139029,rock:7041664,peak:15792383},heightStops:{lowStop:.35,midStop:.55,highStop:.75,rockStop:.85,peakStop:.99}}],Os}}async function sM(s){const{scene:e,worldObjects:t,setMinimapWorldModel:n}=s;try{zn(Oe.loading.terrain());const i=new Li(xt,xt,Zh,Zh),r=i.attributes.position,o=await iM(),a=o[Math.floor(G()*o.length)];console.log(`Generated terrain biome: ${a.name}`);const c=new me(Mt(a.colors.submerged,.1)),l=new me(Mt(a.colors.low,.12)),h=new me(Mt(a.colors.mid,.12)),u=new me(Mt(a.colors.high,.15)),d=new me(Mt(a.colors.rock,.15)),f=new me(Mt(a.colors.peak,.1)),g=Tt,x=Tt+Bt*(a.heightStops.lowStop+(G()*.1-.05)),m=Tt+Bt*(a.heightStops.midStop+(G()*.1-.05)),p=Tt+Bt*(a.heightStops.highStop+(G()*.08-.04)),T=Tt+Bt*(a.heightStops.rockStop+(G()*.06-.03)),v=Tt+Bt*(a.heightStops.peakStop+(G()*.02-.01)),_=Bt*(1+(G()*.2-.1)),y=[];for(let F=0;F<r.count;F++){const q=r.getX(F),V=r.getY(F);let K=tM(q,V,fM,Bt);K<Tt&&(K=Tt-xf),r.setZ(F,K);let ee=new me;const fe=sa(q*.3,V*.3)*.5+.5,Ce=sa(q*.5,V*.5)*.5+.5;if(K<g)ee.copy(c);else if(K<x){const Pe=pn.clamp((K-g)/(x-g),0,1);ee.copy(c).lerp(l,Pe)}else if(K<m){const Pe=pn.clamp((K-x)/(m-x),0,1);ee.copy(l).lerp(h,Pe)}else if(K<p){const Pe=pn.clamp((K-m)/(p-m),0,1);ee.copy(h).lerp(u,Pe)}else if(K<T){const Pe=pn.clamp((K-p)/(T-p),0,1),We=new me().copy(d).lerp(u,fe*.3);ee.copy(u).lerp(We,Pe)}else if(K<v){const Pe=new me().copy(d).lerp(u,fe*.5);ee.copy(Pe)}else{const Pe=pn.clamp((K-v)/(_-v),0,1);ee.copy(d).lerp(f,Pe);const We=Ce*.08;ee.r=Math.min(1,ee.r+We),ee.g=Math.min(1,ee.g+We),ee.b=Math.min(1,ee.b+We)}y.push(ee.r,ee.g,ee.b)}r.needsUpdate=!0,i.computeVertexNormals(),i.boundsTree=new su(i),i.setAttribute("color",new Ct(y,3));const E=new ya,w=[{ao:"_rocks_02_ao_4k.jpg",normal:"_rocks_02_nor_gl_4k.jpg",roughness:"_rocks_02_rough_4k.jpg"},{ao:"_rocks_04_ao_4k.jpg",normal:"_rocks_04_nor_gl_4k.jpg",roughness:"_rocks_04_rough_4k.jpg"},{ao:"_mud_03_ao_4k.jpg",normal:"_mud_03_nor_gl_4k.jpg",roughness:"_mud_03_rough_4k.jpg"},{ao:"_ground_01_ao_4k.jpg",normal:"_ground_01_nor_gl_4k.jpg",roughness:"_ground_01_rough_4k.jpg"},{ao:"/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/textures/terrain/red_mud_stones_ao_4k.jpg",normal:"/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/textures/terrain/red_mud_stones_nor_gl_4k.jpg",roughness:"/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/textures/terrain/red_mud_stones_rough_4k.jpg"},{ao:"/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/textures/rock/mossy_rock_ao_4k.jpg",normal:"/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/textures/rock/mossy_rock_nor_gl_4k.jpg",roughness:"/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/textures/rock/mossy_rock_rough_4k.jpg"},{ao:"/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/textures/rock/coral_fort_wall_02_ao_4k.jpg",normal:"/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/textures/rock/coral_fort_wall_02_nor_gl_4k.jpg",roughness:"/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/textures/rock/coral_fort_wall_02_rough_4k.jpg"},{ao:"_blocks_02_ao_4k.jpg",normal:"_blocks_02_nor_gl_4k.jpg",roughness:"_blocks_02_rough_4k.jpg"},{ao:"/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/textures/rock/forest_ground_04_ao_4k.jpg",normal:"/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/textures/rock/forest_ground_04_nor_gl_4k.jpg",roughness:"/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/treasurehunt/textures/rock/forest_ground_04_rough_4k.jpg"}],R=Math.floor(G()*w.length),M=w[R],S=Math.floor(G()*48+48),P=E.load(M.ao,F=>{F.wrapS=F.wrapT=Bn,F.repeat.set(S,S)}),C=E.load(M.normal,F=>{F.wrapS=F.wrapT=Bn,F.repeat.set(S,S)}),D=E.load(M.roughness,F=>{F.wrapS=F.wrapT=Bn,F.repeat.set(S,S)}),N=new ls({color:16777215,vertexColors:!0,fog:!0,aoMap:P,normalMap:C,roughnessMap:D}),O=new Qe(i,N);return O.rotation.x=-Math.PI/2,O.position.y=0,O.receiveShadow=!0,O.castShadow=!0,e.add(O),O.geometry.computeBoundsTree=()=>O.geometry.boundsTree,t.push(O),nM(e,t),n(i),O}catch(i){console.warn("Error creating world:",i),zn(Oe.loading.terrainError())}}const On=new tf,bl=new L(0,-1,0),rM=new L(0,1,0),oM=new Ve;function ru(s){return s.userData?.isWater===!0}function Bs(s,e=10,t=[]){let n=new L(1,0,0);const i=ks*.5,r=s.clone().add(n.clone().multiplyScalar(-i)),o=s.clone().add(n.clone().multiplyScalar(i));r.y+=e,o.y+=e,On.set(r,bl);const a=On.intersectObjects(t,!0);On.set(o,bl);const c=On.intersectObjects(t,!0);let l=null,h=1/0;for(const u of[a,c])if(u.length>0){const d=u[0],f=d.point.distanceTo(s);f<h&&(l=d,h=f)}return l}function aM(s,e,t=[]){const n=s.clone();n.y=e+10,On.set(n,bl);const i=On.intersectObjects(t,!0);for(const r of i)if(!ru(r.object))return r.point.y;return null}function Wr(s,e=[]){const{areaSize:t=xt-10,spawnAttempts:n=25,minDistanceFromPlayer:i,raycastStartY:r=50,allowWater:o=!1,considerWaterHeight:a=!0,waterHeightThreshold:c=Tt,clearanceHeight:l=3,clearanceOriginOffset:h=.1,maxGroundY:u=1/0,minSlopeDot:d=.85,requireSlopeCheck:f=!0,requireClearance:g=!0,centerX:x=0,centerZ:m=0}=s;for(let p=0;p<n;p++){const T=x+(G()-.5)*t,v=m+(G()-.5)*t;if(i&&new L(T,0,v).distanceTo(ia)<i)continue;const _=new L(T,0,v),y=Bs(_,r,e);if(!y)continue;const E=y.point.y,w=y.object,R=ru(w)||a&&E<=c;if(!(!o&&R)&&!(f&&(!y?.face||y.face.normal.clone().applyMatrix3(oM.getNormalMatrix(w.matrixWorld)).normalize().dot(new L(0,1,0))<d))){if(g&&l>0){const M=y.point.clone();M.y+=h,On.set(M,rM),On.far=l;const S=On.intersectObjects(e,!0);if(On.far=1/0,!(S.length===0))continue}if(!(E>=u))return{position:new L(T,E,v),groundY:E,hitObject:w}}}return null}function yc(s,e){const t=Math.round(s*e),n=Math.max(0,s-t),i=Math.min(255,s+t);return Math.floor(G()*(i-n+1))+n}function Mt(s,e){const t=s>>16&255,n=s>>8&255,i=s&255,r=yc(t,e),o=yc(n,e),a=yc(i,e);return r<<16|o<<8|a}function cM(s,e){return s.clone().lerp(e,.5)}function mf(s){for(const e in s)Object.prototype.hasOwnProperty.call(s,e)&&(s[e]=!1)}async function lM(){const s=document.createElement("canvas"),e=s.getContext("webgl2")||s.getContext("webgl")||s.getContext("experimental-webgl");if(!e)return"low";const t=e.getParameter(e.RENDERER).toLowerCase();if(console.log("Renderer: "+t),t){if(t.includes("nvidia"))return t.includes("rtx")||t.includes("gtx")?"high":"medium";if(t.includes("amd")||t.includes("radeon"))return t.includes("rx")||t.includes("vega")?"high":"medium";if(t.includes("intel")&&(t.includes("iris xe")||t.includes("arc")))return"medium";if(t.includes("apple"))return"high"}return"low"}const on=G()>.8,na=G()>.75,gf=Mt(5405695,.3),_f=Mt(13626615,.15),uM=20,ou=G()*100+50,pa=G()*50+50,Xr=G(),$h=ou*1.5,hM=$h*$h,xt=250,Zh=64,dM=25,Jh=8,Bt=G()*(dM-Jh)+Jh,fM=.05,Tt=-1-G()*15,pM=G()*.2,Rl=new me(Mt(4874365,.1)),mM=G()*5e5+5e5,Zi=2,gM=1.8,Tr=2,_M=1,xM=1,xf=1.2,ks=.8,vM=15,yM=-30,Mc=200,ia=new L(0,Bt,0),Cl=Math.max(.01,G()*.5+.5),vf=Math.max(1,Math.floor(Cl*1e4)),Hs=80,MM=20,SM=5,TM=.1,EM=.2,yf=50,wM=4474111,AM=16777215,Qh=200,bM=60,ed=1e3/bM,RM=.1;let ri,si,hn,bi;function CM(s){hn=new cf({antialias:!0,alpha:!0}),hn.setSize(Qh,Qh),hn.domElement.style.position="absolute",hn.domElement.style.bottom="20px",hn.domElement.style.right="20px",hn.domElement.style.border="3px solid #333",hn.domElement.style.borderRadius="10px",hn.domElement.style.backgroundColor="rgba(0, 0, 0, 0.5)",hn.domElement.style.zIndex="1000",document.body.appendChild(hn.domElement),ri=new Vd,ri.background=s,si=new Ma(-100,100,100,-100,1,500),si.position.set(0,200,0),si.lookAt(0,0,0);const e=new Zl(16777215,1);e.position.set(0,50,0),ri.add(e);const t=new Zm(16777215,.2);ri.add(t);const n=new Qe(new jl(5,15,3),new Vt({color:16777215}));n.rotation.x=-Math.PI/2,bi=new gn,bi.add(n),bi.position.y=50,ri.add(bi)}function PM(s){let e=new Qe(s.clone(),new ls({color:16777215,vertexColors:!0,side:zt,fog:!1}));e.rotation.x=-Math.PI/2,e.position.y=0,ri.add(e);const t=new Qe(new Li(xt*3,xt*3),new Vt({color:Rl,side:zt}));t.rotation.x=-Math.PI/2,t.position.y=Tt-.01,ri.add(t);let n;n=new Qe(new Li(xt,xt),new Vt({color:Rl,side:zt})),n.rotation.x=-Math.PI/2,n.position.y=Tt,ri.add(n)}function LM(s){!bi||!si||!hn||(bi.position.x=s.position.x,bi.position.z=s.position.z,bi.rotation.y=s.rotation.y,si.position.x=s.position.x,si.position.y=250,si.position.z=s.position.z,si.lookAt(s.position.x,50,s.position.z),hn.render(ri,si))}function IM(s,e,t=256,n=256){const i=new me(s),r=new me(e),o=document.createElement("canvas");o.width=t,o.height=n;const a=o.getContext("2d"),c=a.createLinearGradient(0,0,0,n);c.addColorStop(0,"#"+i.getHexString()),c.addColorStop(1,"#"+r.getHexString()),a.fillStyle=c,a.fillRect(0,0,t,n);const l=new Et(o);return l.colorSpace=Rt,l.needsUpdate=!0,l}const Mf=IM(gf,_f),Sf=cM(new me(_f),new me(gf));function DM(s){const e=xt*2,t=new ai(e,128,128),n=new Vt({map:Mf,side:Ht,fog:!1,depthWrite:!1}),i=new Qe(t,n);i.name="SkyDome",i.rotation.y=Math.PI/2,s.add(i)}function UM(s){const e=new qm(Mt(16777215,.15),Mt(6710886,.25),G()+2);e.position.set(0,100,0),e.castShadow=!1,s.add(e);const t=new Zl(Mt(16767093,.15),G()*1.5+(on?1.5:2));t.position.set(0,pa,0),t.target.position.set(0,0,0),t.castShadow=!0;const n=50;return t.shadow.camera.left=-n,t.shadow.camera.right=n,t.shadow.camera.top=n,t.shadow.camera.bottom=-n,t.shadow.camera.near=1,t.shadow.camera.far=500,t.shadow.mapSize.width=4096,t.shadow.mapSize.height=4096,t.shadow.bias=.001,t.shadow.normalBias=.9,s.add(t),s.add(t.target),{dirLight:t,hemiLight:e}}const NM=`
    uniform float time;
